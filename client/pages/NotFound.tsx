      ...
      <div className="container mx-auto px-4">
        <Card className="max-w-2xl mx-auto border-music-300/30 shadow-xl bg-card/80 backdrop-blur-sm text-center">
          <CardHeader className="pb-6">
            ...
            <CardTitle className="text-4xl text-music-800 mb-2">
              404 - Beat Not Found
            </CardTitle>
            <CardDescription className="text-lg text-music-600">
              Oops! This page seems to have gone off-key. The rhythm you're
              looking for doesn't exist in our playlist.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-emotion-purple/10 rounded-full border border-emotion-purple/30">
              ...
              <span className="text-sm font-medium text-music-700">
                Don't worry, the music never stops!
              </span>
            </div>

            <p className="text-music-600 max-w-md mx-auto">
              The page you're looking for doesn't exist, but we have an amazing
              emotion-driven music platform waiting to discover your perfect
              soundtrack.
            </p>
