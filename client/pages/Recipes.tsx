...
const recipes = [
  {
    ...
    description: "The traditional recipe that started it all - simple, fresh, and absolutely delicious",
    time: "15 min",
    serves: "4-6",
    difficulty: "Easy",
    featured: true,
  ...
  },
  {
    ...
    description: "Turn up the heat with extra jalapeños and a hint of cayenne pepper",
    time: "20 min",
    serves: "4-6", 
    difficulty: "Easy",
    featured: false,
  ...
  },
  {
    ...
    description: "A festive twist with pomegranate seeds for extra crunch and sweetness",
    time: "25 min",
    serves: "4-6",
    difficulty: "Medium",
    featured: false,
  ...
  },
  {
    ...
    description: "Indulgent guacamole with crispy bacon bits for the ultimate comfort food",
    time: "30 min",
    serves: "4-6",
    difficulty: "Medium",
    featured: false,
  ...
  },
  {
    ...
    description: "Fresh mango chunks add tropical sweetness to this summer favorite",
    time: "20 min",
    serves: "4-6",
    difficulty: "Easy",
    featured: false,
  ...
  },
  {
    ...
    description: "Smoky roasted corn kernels add texture and depth to classic guacamole",
    time: "35 min",
    serves: "4-6",
    difficulty: "Medium",
    featured: false,
        ...
        <div className="relative container mx-auto px-4 py-16">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-guac-500/10 rounded-full border border-guac-300/30 glow-lime">
              ...
              <span className="text-sm font-medium text-guac-700">Recipe Collection</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-guac-700 mb-8 max-w-2xl mx-auto">
              Explore our complete collection of guacamole recipes, from classic to creative variations
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
          ...
          {recipes.map((recipe, index) => (
            ...
            >
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-guac-800">{recipe.title}</CardTitle>
                <CardDescription className="text-guac-600">{recipe.description}</CardDescription>
              </CardHeader>
              
              <CardContent className="space-y-4">
                <div className="flex flex-wrap gap-2 justify-center">
                  <Badge variant="secondary" className="bg-guac-200/50 text-guac-800 border-guac-300">
        ...
        <div className="text-center mt-16">
          <Card className="max-w-2xl mx-auto border-guac-300/30 shadow-xl bg-gradient-to-r from-guac-50/80 to-guac-100/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl text-guac-800">Can't find what you're looking for?</CardTitle>
              <CardDescription className="text-guac-600">
                We're constantly adding new recipes to our collection. Check back soon for more delicious guacamole variations!
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button 
