...
const DEFAULT_WORDS = ["ENVOICVERSE", "MUSIC", "EMOTION", "AI", "ARTIST"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS, className = "" }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    // Generate new color with purple/blue theme
    const colors = [
  ...
  return (
    <div className={`flex flex-col items-center justify-center p-4 ${className}`}>
      <canvas
        ref={canvasRef}
        className="border border-music-300/50 rounded-lg shadow-2xl bg-gradient-to-br from-music-900/90 to-music-950/90 backdrop-blur-sm"
        style={{ maxWidth: "100%", height: "auto" }}
      />
      <div className="mt-4 text-center max-w-md">
        <p className="text-sm text-music-600 mb-2">Interactive Particle Text Effect</p>
        <p className="text-xs text-music-500">
